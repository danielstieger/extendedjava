...
<model ref="r:570e8b99-0b81-4088-afd2-3b358a41e287(com.hlag.entitylang.editor)">
  ...
  <node concept="24kQdi" id="1kgMMKTCz2i">
    ...
    <node concept="PMmxH" id="uXlZoIlf7j" role="6VMZX">
  ...
  <node concept="24kQdi" id="1kgMMKTFrvL">
    ...
    <node concept="1iCGBv" id="1kgMMKTFrvN" role="2wV5jI">
      ...
      <node concept="1sVBvm" id="1kgMMKTFrvP" role="1sWHZn">
        <node concept="1HlG4h" id="3STiRXRfRK0" role="2wV5jI">
          <node concept="1HfYo3" id="3STiRXRfRK2" role="1HlULh">
            <node concept="3TQlhw" id="3STiRXRfRK4" role="1Hhtcw">
              <node concept="3clFbS" id="3STiRXRfRK6" role="2VODD2">
                <node concept="3clFbF" id="3STiRXRkbeB" role="3cqZAp">
                  <node concept="2OqwBi" id="3STiRXRkbjr" role="3clFbG">
                    <node concept="pncrf" id="3STiRXRkbeA" role="2Oq$k0" />
                    <node concept="2qgKlT" id="3STiRXRkbKW" role="2OqNvi">
  ...
  <node concept="PKFIW" id="2AlxPT0fBO9">
    ...
    <node concept="3EZMnI" id="2AlxPT0dt$B" role="2wV5jI">
      ...
      <node concept="3F2HdR" id="4$MXrxpNbrF" role="3EZMnx">
        <ref role="1NtTu8" to="5zrl:2AlxPT0dt5A" />
        <node concept="2iRkQZ" id="4$MXrxpNbrG" role="2czzBx" />
        <node concept="3F0ifn" id="4$MXrxpOCYB" role="2czzBI">
          <property role="3F0ifm" value="" />
          <property role="ilYzB" value="&lt;entity key jpa&gt;" />
        </node>
      </node>
      <node concept="3F0ifn" id="4$MXrxpNbnv" role="3EZMnx" />
      ...
      <node concept="3vyZuw" id="4$MXrxpPFoK" role="3F10Kt">
        <property role="VOm3f" value="true" />
      </node>
      <node concept="VLuvy" id="4$MXrxpPFuM" role="3F10Kt">
        <property role="Vb096" value="lightGray" />
      </node>
      <node concept="1HlG4h" id="4$MXrxpQpFK" role="AHCbl">
        <node concept="1HfYo3" id="4$MXrxpQpFL" role="1HlULh">
          <node concept="3TQlhw" id="4$MXrxpQpFM" role="1Hhtcw">
            <node concept="3clFbS" id="4$MXrxpQpFN" role="2VODD2">
              <node concept="3clFbF" id="4$MXrxpQpQK" role="3cqZAp">
                <node concept="3cpWs3" id="4$MXrxpQsEI" role="3clFbG">
                  <node concept="Xl_RD" id="4$MXrxpQsF3" role="3uHU7w">
                    <property role="Xl_RC" value=" ..." />
                  </node>
                  <node concept="3cpWs3" id="4$MXrxpQqa7" role="3uHU7B">
                    <node concept="Xl_RD" id="4$MXrxpQpQJ" role="3uHU7B">
                      <property role="Xl_RC" value="... EntityKey " />
                    </node>
                    <node concept="2OqwBi" id="4$MXrxpQqSd" role="3uHU7w">
                      <node concept="pncrf" id="4$MXrxpQqFb" role="2Oq$k0" />
                      <node concept="3TrcHB" id="4$MXrxpQrFZ" role="2OqNvi">
